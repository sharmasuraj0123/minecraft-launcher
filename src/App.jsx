      ...
      <StyledContainer>
        ...
        <InfoBox elevation={3}>
          <Typography variant="body1" gutterBottom sx={{ color: 'text.primary' }}>
            In order to use the launcher, first register your agent as part of Mother registry{' '}
            <Link href="#" color="primary" underline="hover">here</Link>.
          </Typography>
        </InfoBox>
        ...
        <AgentListContainer elevation={3}>
          ...
          {agents.length === 0 ? (
            <Typography variant="body1" sx={{ textAlign: 'center', color: 'text.secondary' }}>
              No agents are currently running. Launch a new agent to get started.
            </Typography>
          ) : (
            <List>
              {agents.map((agent, index) => (
                ...
                >
                  <ListItemText
                    primary={agent.name}
                    secondary={`Role: ${agent.role.charAt(0).toUpperCase() + agent.role.slice(1)}`}
          ...
          <FormContainer>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <FormControl sx={{ mt: 2, mb: 1 }} required>
                <FormLabel sx={{ color: 'text.secondary' }}>Agent Role</FormLabel>
                <RadioGroup
                  row
                  name="role"
                  value={formData.role}
              ...
              <TextField
                fullWidth
                label={apiType === 'openai' ? 'OpenAI API Key' : 'GaiaNet Node URL'}
                name="apiKey"
